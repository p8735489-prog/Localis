...
| 项目 | 值 |
|---|---|
| Keystore 密码 | 由你在 GitHub Secret 中设置 |
| Key 别名 | `localis` |
| Key 密码 | 由你在 GitHub Secret 中设置 |
...
不要把 Base64 编码的 keystore 保存进仓库；请在本机临时生成后直接写入 GitHub Secret。
...
| `SIGNING_STORE_PASSWORD` | 你的 keystore 密码 |
