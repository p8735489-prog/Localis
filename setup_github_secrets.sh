...
echo "正在设置 SIGNING_STORE_PASSWORD..."
gh secret set SIGNING_STORE_PASSWORD --repo "$REPO" --body "localis2024"

echo "正在设置 SIGNING_KEY_ALIAS..."
gh secret set SIGNING_KEY_ALIAS --repo "$REPO" --body "localis"

echo "正在设置 SIGNING_KEY_PASSWORD..."
gh secret set SIGNING_KEY_PASSWORD --repo "$REPO" --body "localis2024"
